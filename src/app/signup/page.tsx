...
import { Zap, Mail, Lock, Eye, EyeOff, ArrowRight, User, CheckCircle2 } from "lucide-react";

const benefits = [
  "AI-powered side hustle matching quiz",
  "Personalized 30-day playbook",
    ...
    <div className="min-h-[calc(100vh-4rem)] bg-gray-50 flex items-center justify-center py-12 px-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Start your side hustle journey today</p>
        </div>
